                             ...
                             $html.="
                                        ...
                                        <div class='container' style='text-align:left; border:2px dotted black;'>
                                              ...
                                              <div class='container-2'>
                                                  ...
                                                  <div class='box-2'>
                                                      <h2>$name</h2>
                                                      <p style='font-size: 14px; color: black'>Residence</p>
                                                  </div>
                                                  <div class='box-3'>
                                              ...
                                              <div class='container-3'>
                                                  ...
                                                  <div class='info-4'>
                                                      <center><center><div class='id'>
                                                        <h4>ID No.</h4>
                                                        <p>$id_no</p>
                                                      </div></center></center>
                                                      <div class='sign'>
                                                          <p style='font-size:12px;    margin-bottom: 8px;'>Signature</p>
...
.header {
    ...
    /* box-shadow: 0 1px 10px rgb(146 161 176 / 50%); */
    /* border-radius: 10px; */
    background-image: url(assets/images/brgy-bg.png);
    overflow: hidden;
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="index.php">Add ID Card <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
  ...
  <div class="col-sm-6">
    <div class="card jumbotron">
      <div class="card-body">
        ...
        <label for="exampleInputEmail1">Residence Id Card No.</label>
        <input class="form-control mr-sm-2" type="search" placeholder="Enter Id Card No." name="id_no">
        <small id="emailHelp" class="form-text text-muted">Every residence's should have unique Id no.</small>
        <br>
